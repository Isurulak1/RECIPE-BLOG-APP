...
const Footer = () => {
  return (
    <footer>
  <div className=" bg-white mx-auto max-w-screen-xl space-y-8 px-4 py-12 sm:px-6 lg:space-y-16 lg:px-8">
   ...
   <hr />
    ...
    <p className="text-xs text-center text-gray-500">&copy; 2025. Company Name. All rights reserved.</p>
  </div>
</footer>
  )
}
