...
const Card = ({item}) => {
  const categoryStyles = {
    ...
    Drinks: {backgroundColor:'#ffeae3', color:'#f0493c'},
    ...
    <div className='container mx-auto flex justify-center md:justify-start'>
      <div className='max-w-sm'>
        <div className='bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg'>
          ...
          <div className='py-8 px-5 rounded-lg bg-white'>
            <Link to={`/items/${item._id}`}>
              <h1 className='text-gray-600 font-bold text-2xl mb-8 hover:text-gray-900 hover:cursor-pointer'>{item?.name}</h1>
            </Link>
          ...
          <div className='absolute top-2 right-2 py-1 px-4 bg-white rounded-lg'>
